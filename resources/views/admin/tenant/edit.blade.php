...
@section('content')
    <div class="box box-info">
        ...
        <form class="form form-horizontal" method="post"
              action="{{ URL::action("Admin\\TenantController@update", $model['id']) }}">
            {{ csrf_field() }}
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        <input id="contact_person" name="contact_person" type="text" class="form-control"
                               placeholder="请输入联系人" value="{{ $model['contact_person'] }}"/>
                    </div>
                    <div class="col-sm-3">
                    </div>
                </div>
            ...
            <div class="box-footer">
                <div class="col-sm-offset-2 col-sm-10">
                    ...
                    <a href="{{ URL::action("Admin\\TenantController@index") }}" class="btn btn-default">返回</a>
                </div>
            </div>
        </form>
    </div>
